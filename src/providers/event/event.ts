...
export class EventProvider {
  ...
  idx:string;
  endpoint:string = API_MARVEL.events;
  ...
  events:any = Object.assign( { endPoint: '' }, this.baseObject );
  event:any = Object.assign( { endPoint: '' }, this.baseObject );
  eventComics:any = Object.assign( { endPoint: '/comics' }, this.baseObject );
  eventCharacters:any = Object.assign( { endPoint: '/characters' }, this.baseObject );
  eventCreators:any = Object.assign( { endPoint: '/creators' }, this.baseObject );
  eventSeries:any = Object.assign( { endPoint: '/series' }, this.baseObject );
  eventStories:any = Object.assign( { endPoint: '/stories' }, this.baseObject );
