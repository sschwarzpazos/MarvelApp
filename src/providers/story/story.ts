...
export class StoryProvider {
    ...
    idx:string;
    endpoint:string = API_MARVEL.stories;
    ...
    stories:any = Object.assign( { endPoint: '' }, this.baseObject );
    story:any = Object.assign( { endPoint: '' }, this.baseObject );
    storyComics:any = Object.assign( { endPoint: '/comics' }, this.baseObject );
    storyCharacters:any = Object.assign( { endPoint: '/characters' }, this.baseObject );
    storyCreators:any = Object.assign( { endPoint: '/creators' }, this.baseObject );
    storyEvents:any = Object.assign( { endPoint: '/events' }, this.baseObject );
    storySeries:any = Object.assign( { endPoint: '/series' }, this.baseObject );
